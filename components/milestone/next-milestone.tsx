...
export function NextMilestone({ things, total, currency }: NextMilestoneProps) {
  ...
  return (
    <div className="overflow-hidden relative rounded-lg border bg-white/60 p-6 dark:border-slate-800 dark:bg-slate-900/60">
        ...
        {nextThing ?
          <>
            ...
            <div className="mt-2 text-xs text-slate-500 dark:text-slate-400">
              {Math.round(nextThingProgress)}% of next item
            </div>
          </>
